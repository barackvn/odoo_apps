...
{
    'name': 'Employee Portal for Issue Tracking System',
    'version': '1.0',
    'category' : 'Project',
        'price': 9.0,
    ...
    'summary': """Portal for employee to work on issue tracking system.""",
    'description': """
    - This module allow Employees to show own Issues
        - Employee can show own issues from frontend
        - Send reply of the customers issue comments
...
odoo Construction
    ...
    'live_test_url': 'https://youtu.be/G36j45sgvdw',
    'data':[
        'views/issue_template_view.xml',
    ],
    'installable' : True,
    'application' : False,
}
